...
public class OinkFacadeIT extends OinkKarafITSupport {
	...
	@Test
	public void checkFacadeHasASingleConfigPidAssociatedInTheFeaturesRepo()
			throws Exception {
	...
	public TestProbeBuilder probeConfiguration(TestProbeBuilder probe) {
		probe.setHeader(
				...
				"*,org.apache.felix.service.*,org.springframework.osgi.context.event.*;status=provisional");
		return probe;
	}
