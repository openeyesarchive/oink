...
/**
 * Represents a GP, see:
 * http://systems.hscic.gov.uk/data/ods/supportinginfo/filedescriptions#_Toc350757586
 *
 */
public class NHSPractitioner {

	public NHSPractitioner() {

	}

	public NHSPractitioner(String csvLine) {
		...
		generalPractitionerCode = columns[0];
		name = columns[1];
		...
		currentCareOrganisation = columns[23];
	}

	public static Map<String, NHSPractitioner> convert(List<String> rows) {

		Map<String, NHSPractitioner> items = new HashMap<String, NHSPractitioner>();

		for (String row : rows) {
			try {
				NHSPractitioner item = new NHSPractitioner(row);
				items.put(item.getGeneralPractitionerCode(), item);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	private String generalPractitionerCode;
	private String name;
	...
	private String currentCareOrganisation;

	private Map<String, NHSPractice> practices = new HashMap<String, NHSPractice>();
	...
	public String getCurrentCareOrganisation() {
		return currentCareOrganisation;
	}

	public void setCurrentCareOrganisation(String currentCareOrganisation) {
		this.currentCareOrganisation = currentCareOrganisation;
	}

	public Map<String, NHSPractice> getPractices() {
		return practices;
	}

	public void setPractices(Map<String, NHSPractice> practices) {
		this.practices = practices;
	}

	public String getGeneralPractitionerCode() {
		return generalPractitionerCode;
	}

	public void setGeneralPractitionerCode(String generalPractitionerCode) {
		this.generalPractitionerCode = generalPractitionerCode;
	}
}
