<?xml version="1.0" encoding="UTF-8" standalone="no"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://hl7.org/fhir" xmlns:a="http://www.w3.org/2005/Atom" xmlns:oms="urn:hl7-org:v2xml" version="2.0">
	...
	<xsl:template name="a:id_6">
		...
		<a:id>
			<xsl:variable name="fhir_id_8" select="$resources.Patient_in/oms:PID.3/oms:CX.1[(parent::node()/oms:CX.5 = 'PAS')]"/>
	...
	<xsl:template name="Patient_8">
		...
		<Patient>
			...
			<xsl:variable name="complexTypes.Identifier_in" select="$v_9/self::node()"/>
			<xsl:variable name="v_14" select="$resources.Patient_in/oms:PID.8"/>
			<xsl:variable name="complexTypes.CodeableConcept_in" select="$v_14/self::node()"/>
			...
			<xsl:variable name="complexTypes.HumanName_in" select="$v_22/self::node()"/>
			<xsl:variable name="v_31" select="$resources.Patient_in/oms:PID.11"/>
			<xsl:variable name="complexTypes.Address_in" select="$v_31/self::node()"/>
			...
			<xsl:apply-templates mode="comp_m6" select="$complexTypes.HumanName_in"/>
			<xsl:apply-templates mode="comp_m11" select="$complexTypes.Address_in"/>
		</Patient>
	</xsl:template>
	<xsl:template match="oms:PID.3" mode="comp_m3">
		...
		<identifier>
			...
			<xsl:variable name="system_12" select="$complexTypes.Identifier_in/oms:CX.5"/>
	...
	<xsl:template name="system_10">
		...
		<system>
			<xsl:variable name="system_13" select="$complexTypes.Identifier_in/oms:CX.5"/>
	...
	<xsl:template match="oms:PID.8" mode="comp_m4">
		...
		<gender>
			...
			<xsl:variable name="complexTypes.Coding_in" select="$v_15/self::node()"/>
	...
	<xsl:template match="oms:PID.5" mode="comp_m6">
		...
		<name>
			...
			<xsl:variable name="primitiveTypes.String__subset_s3_in" select="$v_23/self::node()"/>
			<xsl:variable name="v_25" select="$complexTypes.HumanName_in/oms:XPN.4"/>
			<xsl:variable name="primitiveTypes.String__subset_s2_in" select="$v_25/self::node()"/>
			<xsl:variable name="v_27" select="$complexTypes.HumanName_in/oms:XPN.2"/>
			<xsl:variable name="primitiveTypes.String__subset_s1_in" select="$v_27/self::node()"/>
			<xsl:variable name="v_29" select="$complexTypes.HumanName_in/oms:XPN.1"/>
			<xsl:variable name="primitiveTypes.String__in" select="$v_29/self::node()"/>
			<xsl:apply-templates mode="prim_m7" select="$primitiveTypes.String__subset_s3_in"/>
			<xsl:apply-templates mode="prim_m8" select="$primitiveTypes.String__subset_s2_in"/>
			<xsl:apply-templates mode="prim_m9" select="$primitiveTypes.String__subset_s1_in"/>
			<xsl:apply-templates mode="prim_m10" select="$primitiveTypes.String__in"/>
		</name>
	</xsl:template>
	...
	<xsl:template match="oms:PID.11" mode="comp_m11">
		...
		<address>
			...
			<xsl:variable name="primitiveTypes.String__subset_s4_in" select="$v_36/self::node()"/>
			...
			<xsl:apply-templates mode="prim_m12" select="$primitiveTypes.String__subset_s4_in"/>
