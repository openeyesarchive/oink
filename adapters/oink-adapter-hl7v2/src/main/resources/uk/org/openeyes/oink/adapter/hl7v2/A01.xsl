<?xml version="1.0" encoding="UTF-8" standalone="no"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://hl7.org/fhir" xmlns:a="http://www.w3.org/2005/Atom" xmlns:oms="urn:hl7-org:v2xml" xmlns:x="http://www.w3.org/1999/xhtml" version="2.0">
	...
	<xsl:template name="Patient_8">
		...
		<Patient>
			...
			<xsl:variable name="v_35" select="$resources.Patient_in/ancestor::oms:ADT_A01/oms:NK1"/>
			...
			<xsl:variable name="v_92" select="$resources.Patient_in/ancestor::oms:ADT_A01/oms:PD1/oms:PD1.4/oms:XCN.1"/>
			<xsl:variable name="v_93" select="$v_92/ancestor::oms:PD1.4"/>
			<xsl:variable name="v_94" select="$v_93/self::node()"/>
			<xsl:variable name="feed.AtomFeed_in" select="($v_94/ancestor::oms:ADT_A01)[1]"/>
			<xsl:variable name="resources.Practitioner_in" select="$v_93/self::node()[($feed.AtomFeed_in)]"/>
			<xsl:variable name="v_100" select="$resources.Patient_in/ancestor::oms:ADT_A01/oms:PD1/oms:PD1.3/oms:XON.3"/>
			<xsl:variable name="v_101" select="$v_100/ancestor::oms:PD1.3"/>
			<xsl:variable name="v_102" select="$v_101/self::node()"/>
			<xsl:variable name="feed.AtomFeed_in" select="($v_102/ancestor::oms:ADT_A01)[1]"/>
	...
	<xsl:template name="reference_29">
		...
		<reference>
			<xsl:variable name="v_95">
				<xsl:variable name="v_96" select="$resources.Patient_in/ancestor::oms:ADT_A01/oms:PD1/oms:PD1.4/oms:XCN.1"/>
				<xsl:variable name="v_97" select="$v_96/ancestor::oms:PD1.4"/>
				<xsl:variable name="v_98" select="$v_97/self::node()"/>
				<xsl:variable name="feed.AtomFeed_in" select="($v_98/ancestor::oms:ADT_A01)[1]"/>
	...
	<xsl:template name="reference_30">
		...
		<reference>
			<xsl:variable name="v_103">
				<xsl:variable name="v_104" select="$resources.Patient_in/ancestor::oms:ADT_A01/oms:PD1/oms:PD1.3/oms:XON.3"/>
				<xsl:variable name="v_105" select="$v_104/ancestor::oms:PD1.3"/>
				<xsl:variable name="v_106" select="$v_105/self::node()"/>
				<xsl:variable name="feed.AtomFeed_in" select="($v_106/ancestor::oms:ADT_A01)[1]"/>
	...
	<xsl:template name="Practitioner_45">
		...
		<Practitioner>
			...
			<xsl:variable name="feed.AtomFeed_in" select="($v_142/ancestor::oms:ADT_A01)[1]"/>
	...
	<xsl:template name="reference_46">
		...
		<reference>
			<xsl:variable name="v_143">
				...
				<xsl:variable name="feed.AtomFeed_in" select="($v_146/ancestor::oms:ADT_A01)[1]"/>
